  ...
  return (
    <aside className="fixed inset-y-0 left-0 w-[220px] flex flex-col border-r border-border bg-surface z-50">
      ...
      <div className="flex items-center gap-3 px-5 py-5 border-b border-border">
        ...
        <div className="h-10 p-1.5 rounded-xl bg-accent shadow-sm">
          <Image
            src={LightHouseLogo}
            alt="Lighthouse Logo"
        ...
        <div>
          <p className="text-[15px] font-semibold text-text leading-tight">
            Lighthouse OS
          </p>
        </div>
      </div>
      ...
      <nav className="flex-1 py-4 overflow-y-auto">
        <p className="px-5 pb-2 text-[10px] font-semibold uppercase tracking-widest text-faint">
          Navigation
        </p>
      ...
      <div className="px-5 py-4 border-t border-border">
        <p className="text-[10px] text-faint">Databricks · Claude · Kumo.AI</p>
